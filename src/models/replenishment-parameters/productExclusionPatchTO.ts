 ...
 */
import { ProductExclusionAttributeTO } from './productExclusionAttributeTO';
import { ServiceResult } from './serviceResult';


export interface ProductExclusionPatchTO {
    productExclusionAttributeTO: Array<ProductExclusionAttributeTO>;
